...
class Diploma extends StatelessWidget {
  ...
  final TextEditingController controllerDocumentsNumber = TextEditingController();
  ...
  Widget build(BuildContext context) {
    ...
    var isDiplomaCompatible = fullDataAcademicInformation
        ?.isDiplomaCompatible != null ?

    fullDataAcademicInformation?.isDiplomaCompatible == 0 : false;
